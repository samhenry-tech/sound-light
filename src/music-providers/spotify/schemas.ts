 ...
 * mappers to the app's normalized music models.
...
export const mapTrack = (raw: RawSpotifyTrack): MusicTrack => {
  return {
    uri: raw.uri,
    id: raw.id,
    title: raw.name,
...
export const mapPlaylistToSource = (raw: z.infer<typeof spotifyPlaylistSchema>): MusicSource => {
  return {
    uri: raw.uri,
    id: raw.id,
    kind: 'playlist',
...
export const mapSearchResults = (payload: unknown): MusicSearchResults => {
